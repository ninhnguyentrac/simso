...
{
    public partial class tbl_SimSoDep_TangThem
    {
        ...
        public virtual Nullable<int> TangThem
        {
            get;
            set;
        }
        ...
        {
            if (previousValue != null && previousValue.tbl_SimSoDep_TangThem.Contains(this))
            {
                previousValue.tbl_SimSoDep_TangThem.Remove(this);
            }
    
            if (tbl_SimSoDep_DaiLy != null)
            {
                if (!tbl_SimSoDep_DaiLy.tbl_SimSoDep_TangThem.Contains(this))
                {
                    tbl_SimSoDep_DaiLy.tbl_SimSoDep_TangThem.Add(this);
                }
